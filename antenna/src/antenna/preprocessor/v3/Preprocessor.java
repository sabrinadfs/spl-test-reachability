...
//        	/**
//        	 * In order to put all #ifdef and #endif statements on the start
//        	 * of lines, we do the code below.
//        	 */
...
//        lines = newLines;
    ...
    private boolean canAddNotification() {
...
//                    		lines.insertElementAt(notification, i);
        ...
        if (m_currentState != STATE_NO_CONDITIONAL) {
        	if(m_file !=null)
        		System.out.println("Missing #endif -" + m_file.getName() + "line: " + i);
        	throw new PPException("Missing #endif", m_file, -1);
//        	if(m_file != null){
//        		throw new PPException(("Missing #endif -" + m_file.getName() + "line: " + i) , m_file, -1);
//        	}
        }
