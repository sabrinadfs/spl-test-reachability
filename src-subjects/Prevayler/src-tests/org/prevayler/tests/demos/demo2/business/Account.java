...
public class Account implements java.io.Serializable {
  ...
  public long number;//private
  public String holder;//private
  public long balance=0;//private
  public List transactionHistory=new ArrayList();//private
  public transient Set listeners;//private
  public Account(){
  }
  ...
  public String toString(){
    return numberString() + "-" + holder + "-("+balance+","+transactionHistory.size()+")";
  }
